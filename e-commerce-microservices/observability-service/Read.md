...
* Get an customer by ID: ```GET /api/authors/{id}```
* Add a new customer: ```POST /api/authors```
* Update an customer: ```PUT /api/authors/{id}```
* Delete an customer: ```DELETE /api/authors/{id}```
