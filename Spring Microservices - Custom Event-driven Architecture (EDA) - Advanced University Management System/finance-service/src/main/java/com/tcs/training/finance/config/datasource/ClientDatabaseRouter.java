...
@EnableJpaRepositories(basePackages = "com.tcs.training", entityManagerFactoryRef = "multiEntityManager",
...
public class ClientDatabaseRouter {
	...
	public DataSource multiRoutingDataSource() {
		...
		targetDataSources.put(ClientDatabase.OWN, ownDataSource());
		targetDataSources.put(ClientDatabase.SHARED, sharedDataSource());
